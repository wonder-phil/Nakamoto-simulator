...
\item Modify App.js in the \lstinline[language=bash]|src| directory with the code
...
%
%
\begin{lstlisting}[label=subCardListing,style=JSES6Base, caption={Basic Card from React-bootstrap that is a subset of {\em GetLastBurnBlock}}]
